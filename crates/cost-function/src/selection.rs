...
#[derive(Clone, Debug, PartialEq, Eq)]
pub(crate) struct FundingResult {
...
pub(crate) trait CoinSelector {
    ...
    fn select(&self, request: FundingRequest<'_>) -> Result<FundingResult, Self::Error>;
}
...
mod tests {
    ...
    impl CoinSelector for TakeEverything {
        ...
        fn select(&self, request: FundingRequest<'_>) -> Result<FundingResult, NothingOnOffer> {
